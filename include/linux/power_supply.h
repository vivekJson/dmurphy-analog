...
enum {
	POWER_SUPPLY_PROP_USB_OTG_DATA_ROLE_NONE = 0,
	POWER_SUPPLY_PROP_USB_OTG_DATA_ROLE_DEVICE,
	POWER_SUPPLY_PROP_USB_OTG_DATA_ROLE_HOST
};
...
enum power_supply_property {
	...
	POWER_SUPPLY_PROP_USB_OTG_DATA_ROLE,
